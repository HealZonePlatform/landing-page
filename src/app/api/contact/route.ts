      ...
      sendMail({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #fc95ae;">${productName} đã nhận được tin nhắn của bạn</h2>
            ...
            <blockquote style="background: #f9f6ee; padding: 12px 16px; border-radius: 8px; color: #112121;">
    ...
    if (adminRecipients.length) {
      mailTasks.push(
        sendMail({
          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
              <h3 style="color: #fc95ae;">Tin nhắn mới từ khách hàng</h3>
              <ul>
